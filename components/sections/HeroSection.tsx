    ...
    <section id="hero" className="scroll-mt-20 bg-muted/50">
      <div className="mx-auto grid max-w-6xl gap-8 px-4 pb-10 pt-6 sm:px-6 sm:pb-12 sm:pt-10 lg:grid-cols-[1fr_280px] lg:items-center">
        <div>
          ...
          <FadeIn immediate className="mt-3 max-w-xl text-base text-neutral-600 sm:text-lg">
          ...
          <FadeIn immediate className="mt-6 flex flex-col gap-2 sm:flex-row sm:flex-wrap sm:gap-x-6">
        ...
        <FadeIn immediate className="relative mx-auto w-full max-w-[280px] lg:mx-0">
